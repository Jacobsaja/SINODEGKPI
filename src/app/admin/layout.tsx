        ...
        <header className="sticky top-0 z-30 flex h-16 w-full items-center justify-between border-b border-border/80 bg-background/80 px-6 backdrop-blur-md md:h-20">
          <div className="flex items-center gap-3">
            <button
              ...
              className="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-border bg-surface/50 text-text-secondary transition-colors hover:border-accent/40 hover:text-white md:hidden cursor-pointer"
