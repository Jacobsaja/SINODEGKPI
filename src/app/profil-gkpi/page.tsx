...
export default function ProfilGKPIPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-background">
      ...
      <section className="relative flex min-h-[86vh] items-end overflow-hidden bg-background pb-10 pt-32 md:min-h-[90vh] md:pb-14">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-5 sm:px-8">
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
            <ScrollReveal>
              ...
              <div className="mt-9 flex flex-wrap gap-3">
                {[
                  ...
                  { label: "Kepemimpinan & Lembaga", href: "#pemimpin-lembaga" },
                  { label: "Wilayah Pelayanan", href: "#wilayah-pelayanan" },
            ...
            {/* Quick Facts Section from tentang-gkpi */}
            <ScrollReveal>
      ...
      {/* ── Sejarah Singkat (3 Cards from tentang-gkpi) ─────────────────── */}
        ...
        <div className="grid grid-cols-1 gap-12 lg:gap-16 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
          <div className="space-y-5">
            ...
            <p className="text-text-secondary leading-relaxed">
              ...
              awal 1960-an. Ringkasan ini menjaga sejarah tetap ringan, tanpa
      ...
      {/* ── Sejarah GKPI Timeline (from info) ───────────────────────────────── */}
      <section
        id="sejarah"
        className="relative mx-auto max-w-7xl px-5 py-20 sm:px-8 md:py-28 border-t border-border/40"
      >
        <ScrollReveal>
      ...
      {/* ── Motto Pelayanan (from info) ────────────────────────────────────── */}
      <section
        className="py-16 px-4 md:px-8 border-y border-border/40"
        style={{
          background:
      ...
      {/* ── Dokumen & Profil Lengkap (from info) ─────────────────────────────── */}
      <section
        id="dokumen"
        className="relative mx-auto max-w-7xl px-5 py-20 sm:px-8 md:py-28"
      >
      ...
      {/* ── Document Details Modal (from info) ─────────────────────────────────── */}
