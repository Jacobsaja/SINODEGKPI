...
export const metadata: Metadata = {
  ...
  description:
    "Mengenal Gereja Kristen Protestan Indonesia (GKPI): sejarah berdiri sejak 1964, visi menjadi Persekutuan Penyembahan dan Persembahan, Panca Pelayanan, kepemimpinan sinode, lembaga pelayanan, dan wilayah pelayanan GKPI.",
  openGraph: {
    ...
    url: "https://gkpisinode.org/profil-gkpi",
...
export default function ProfilGKPILayout({
  children,
}: {
